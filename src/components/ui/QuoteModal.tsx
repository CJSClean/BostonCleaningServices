      ...
      >
        ...
        {done ? (
          <div className="py-6 text-center">
            <div className="mx-auto mb-5 flex h-16 w-16 items-center justify-center rounded-full bg-seafoam text-navy">
              <CheckIcon className="h-8 w-8" />
            </div>
            <h3 className="font-display text-2xl font-semibold text-navy">Request received</h3>
            <p className="mt-3 text-muted">
              Thanks for reaching out. A coordinator will call or text you shortly with a quote and available times.
            </p>
            <Button variant="navy" className="mt-6 w-full" onClick={close}>Done</Button>
          </div>
        ) : (
          <>
            <p className="eyebrow">Free quote</p>
            <h3 className="font-display mt-1 text-2xl font-semibold text-navy sm:text-3xl">
