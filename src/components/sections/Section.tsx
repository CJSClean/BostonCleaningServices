...
type Tone = "canvas" | "paper" | "sky" | "seafoam" | "navy";
...
export function SectionHeading({
  ...
  return (
    <div className={`mb-10 max-w-3xl ${center ? "mx-auto text-center" : ""}`}>
      {eyebrow && <p className={`eyebrow mb-3 ${light ? "!text-brick-soft" : ""}`}>{eyebrow}</p>}
      <Tag
    ...
    <Section tone={tone}>
      <div className="grid gap-10 lg:grid-cols-12">
        <div className="lg:col-span-4">
          ...
          <h2 className="font-display rule text-3xl font-semibold leading-tight tracking-tight text-navy sm:text-4xl lg:sticky lg:top-32">
            {title}
          </h2>
        </div>
