...
const introParagraphs = [
  "Boston is a city of stairs, radiators, old wood, and small closets, and it takes a certain kind of cleaning company to keep up with it. Boston Cleaning Services was built for exactly this housing stock. We send trained, insured, two-person teams to apartments and houses across the city and the inner suburbs, working from a written checklist that covers every room and finishing with a text to let you know the job is done.",
