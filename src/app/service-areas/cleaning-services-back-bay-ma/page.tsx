...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Move-in and move-out cleans follow the neighborhood's rental calendar, which peaks on September 1 and the first of each month. For sales, we work with agents to have a unit cleaned before photography or between showings. Whatever brings you to us, expect a two-person team, a published checklist, a text when we arrive and finish, and a 24-hour guarantee if anything is missed.",
  ],
