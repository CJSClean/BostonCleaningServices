...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Every job in the county comes with the same guarantees: a flat price confirmed before booking, a two-person team of background-checked employees, texts at arrival and completion, and a 24-hour window in which we return to fix anything missed. Coordinators are reachable seven days a week by phone or text.",
  ],
