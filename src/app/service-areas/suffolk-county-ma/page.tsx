...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Every job in the county comes with the same guarantees: an upfront price confirmed before booking, a team of background-checked employees, texts at arrival and completion, and a 100% satisfaction guarantee. Coordinators are reachable seven days a week by phone or text.",
  ],
