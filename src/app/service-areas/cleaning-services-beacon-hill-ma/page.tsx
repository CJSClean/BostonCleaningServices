...
export const metadata: Metadata = {
  ...
  description:
    "Apartment and townhouse cleaning on Beacon Hill, Boston. Narrow stairs, 200-year-old floors, and tiny bathrooms handled by experienced teams.",
  ...
  faqs: [
    {
      ...
      answer:
        "Yes, and many Beacon Hill units are under 500 square feet. A team completes a studio routine clean in about an hour, and pricing starts at $110.",
    },
    {
