...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Whether you need a biweekly plan for a Cambridgeport condo, a deep clean before a thesis defense celebration, or a move-out clean at the end of a graduate lease, the process is the same: an upfront quote before booking, a trained team, arrival and completion texts, and a 100% satisfaction guarantee. We cover all of Cambridge from Alewife to the Charles.",
  ],
