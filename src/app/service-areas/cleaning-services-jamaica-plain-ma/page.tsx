...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Move cleans follow the first-of-month and September 1 rental cycle, and we coordinate with the many small landlords who own and live in JP triple-deckers. Whatever the job, you get an upfront price before booking, a trained team, a text at arrival and completion, and our 100% satisfaction guarantee.",
  ],
