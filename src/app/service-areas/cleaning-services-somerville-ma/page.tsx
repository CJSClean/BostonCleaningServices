...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Whether it is a monthly visit to a Davis Square studio, a biweekly plan for a shared three-bedroom in Spring Hill, or a move-out clean at the end of a lease near Union Square, you get a flat price before booking, a two-person team, and a 24-hour guarantee. Coordinators are reachable seven days a week.",
  ],
