...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Whether it is a monthly visit to a Davis Square studio, a biweekly plan for a shared three-bedroom in Spring Hill, or a move-out clean at the end of a lease near Union Square, you get an upfront price before booking, an experienced team, and a 100% satisfaction guarantee. Coordinators are reachable seven days a week.",
  ],
  ...
  benefits: [
    ...
    },
    {
      ...
      description: "Hand-dusted radiators in Spring Hill Victorians and streak-free glass in Assembly Row towers, from the same experienced team.",
    },
  ],
