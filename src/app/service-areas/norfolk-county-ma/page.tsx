...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Every Norfolk County visit comes with a consistent lead cleaner, texts at arrival and completion, and a 100% satisfaction guarantee. Coordinators are reachable seven days a week to adjust plans around school vacations, travel, and the arrival of a new baby.",
  ],
