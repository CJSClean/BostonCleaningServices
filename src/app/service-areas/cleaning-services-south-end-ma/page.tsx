...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Turnover cleans follow the first-of-month rental cycle, and we work with agents preparing units for the neighborhood's active sales market, where a deep clean before photographs matters. Whatever the job, you receive an upfront quote before booking, a trained team, arrival and completion texts, and a 24-hour re-clean guarantee.",
  ],
