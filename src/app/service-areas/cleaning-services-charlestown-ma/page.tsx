...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Deep cleans and move cleans follow the neighborhood's rhythm: spring resets after a harbor winter, pre-holiday cleans before family arrives, and turnover cleans around the first of the month for the rental units that fill Charlestown's triple-deckers. Every visit comes with an upfront price, an experienced team, arrival and finish texts, and our 100% satisfaction guarantee.",
  ],
  ...
  benefits: [
    {
      ...
      description: "Period detail on the hill and glass on the water require different products and techniques. Our Charlestown cleaners are experienced with both.",
    },
    {
