...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Deep cleans and move cleans follow the neighborhood's rhythm: spring resets after a harbor winter, pre-holiday cleans before family arrives, and turnover cleans around the first of the month for the rental units that fill Charlestown's triple-deckers. Every visit comes with an upfront price, a trained team, arrival and finish texts, and our 24-hour re-clean guarantee.",
  ],
