  ...
  benefits: [
    {
      ...
      description: "Teams are in both cities daily, which makes same-week booking, evening slots, and quick follow-ups realistic.",
    },
    {
