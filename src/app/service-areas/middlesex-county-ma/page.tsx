...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Whether it is a biweekly plan for a Cambridgeport condo, a move-out clean at the end of a Somerville lease, or a deep clean in an Arlington two-family, every Middlesex County visit comes with a flat quote confirmed before booking, a two-person team, arrival and completion texts, and a 24-hour re-clean guarantee.",
  ],
  ...
  ctaDescription: "Tell us the town, home size, and what you need. A flat quote and available times arrive within the hour.",
