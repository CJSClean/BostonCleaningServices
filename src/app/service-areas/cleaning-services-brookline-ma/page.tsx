...
const content: AreaPageContent = {
  ...
  intro: [
    ...
    "Whatever the property, the process is the same: an upfront quote based on size, layout, and condition, an experienced team, a text when we arrive and finish, and a 100% satisfaction guarantee. Brookline residents can reach a coordinator seven days a week to adjust a plan around school vacations, travel, or a new baby.",
  ],
