...
export const apartmentCleaningCopy: Record<string, ServiceLocationCopy> = {
  ...
  cambridge: {
    ...
    intro: [
      ...
      "For older units, we dry-mop hardwood before a damp pass, dust radiator fins by hand, and scrub tile grout in original bathrooms. For newer buildings, we deliver insurance certificates to management, follow elevator and quiet-hour rules, and clean stone and glass streak-free. In every case the checklist is the same and a one-bedroom takes a two-person team about 90 minutes.",
