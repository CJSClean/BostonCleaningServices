...
export const apartmentCleaningCopy: Record<string, ServiceLocationCopy> = {
  "back-bay": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, every day. Equipment comes up the stairs with the team and there is no stair fee on any Back Bay quote.",
      },
      {
        question: "Can you provide a certificate of insurance to my building?",
        answer:
          "Yes. Most managed buildings around Copley and the Prudential require one and we email it to management within a business day.",
      },
      {
        question: "Can I leave my key with the concierge?",
        answer:
          "Absolutely. Most Back Bay customers in full-service buildings do exactly that. You receive texts when the team arrives and finishes.",
      },
    ],
  ...
  "beacon-hill": {
    ...
    intro: [
      "Beacon Hill apartments are carved out of Federal-era townhouses, and almost none of them are large. Studios on the Flat of the Hill, garden-level one-bedrooms with their own entrances, and top-floor units under sloped roofs are the norm. Kitchens are galleys, bathrooms are tucked under stairs, and closets are afterthoughts. Our apartment cleaning teams carry compact vacuums and short-handled tools and know how to work a small space without knocking anything over.",
      "The surfaces are old and worth protecting. Wide-plank pine floors are dry-mopped before a barely damp pass. Marble sills and mantels get pH-neutral cleaner. Black iron fixtures and painted trim are wiped, not scrubbed. Deep window wells on the street side collect city dust and get attention on every visit. Cast-iron tubs and hex-tile bathroom floors are scrubbed with the right products so grout stays intact.",
      "Beacon Hill renters include Mass General residents, State House staff, and young professionals who chose the neighborhood for its walk to everything. Monthly and biweekly plans are the most common because the units are small enough to stay nearly spotless on a schedule. A studio routine clean takes about an hour and starts at $110. Access is a key or code, and our teams plan around permit parking so it never affects your visit or your quote.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Garden units have their own humidity and dust patterns and our teams pay extra attention to sills, corners, and bathroom ventilation in them.",
      },
      {
        question: "Are your tools small enough for a galley kitchen?",
        answer:
          "Yes. Beacon Hill teams carry compact vacuums and short-handled tools specifically for tight kitchens and bathrooms.",
      },
      {
        question: "Can you work around a roommate who is home?",
        answer:
          "Of course. Tell us which room to do first or last and the team stays out of the way.",
      },
    ],
  ...
  brookline: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Some Brookline associations require a certificate of insurance before vendors enter. We provide it within a business day of your request.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes, most of them have at least one. Tell us about the animals at booking so the team knows what to expect.",
      },
    ],
  ...
  cambridge: {
    ...
    intro: [
      "Cambridge apartments come in three main forms. Triple-decker and two-family floors dominate Cambridgeport, Riverside, and North Cambridge, with long layouts, rear kitchens, and old hardwood. Brick apartment buildings from the early twentieth century cluster around Central, Harvard, and Porter Squares. And new elevator buildings with concierges and stone counters have risen around Kendall Square and East Cambridge. Our apartment cleaning teams move between all three every week.",
      "For older units, we dry-mop hardwood before a damp pass, dust radiator fins by hand, and scrub tile grout in original bathrooms. For newer buildings, we deliver insurance certificates to management, follow elevator and quiet-hour rules, and clean stone and glass streak-free. In every case the checklist is the same and a one-bedroom takes our team about 90 minutes.",
      "Cambridge renters are graduate students, postdocs, researchers, and tech workers whose schedules follow terms and grants rather than a standard week. Recurring plans pause for a conference or a summer away and resume without losing the rate. Sublet handoffs and end-of-lease cleans are routine, especially around September 1. A plant-based, fragrance-free product line is available at no extra cost and saved to your account.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes. We charge one card per visit but many Cambridge customers rotate the card on file or settle up among themselves.",
      },
      {
        question: "Do you clean buildings in Kendall Square?",
        answer:
          "Regularly. We provide insurance certificates, follow elevator rules, and coordinate with the concierge so you can leave a key at the desk.",
      },
      {
        question: "Can I pause service over the summer?",
        answer:
          "Yes. Pauses up to eight weeks hold your slot and rate. Longer breaks restart at the standard rate for one visit.",
      },
    ],
  ...
  charlestown: {
    ...
    intro: [
      ...
      "Charlestown renters and condo owners are young professionals and couples commuting to the Financial District or across to Kendall. Biweekly plans with a consistent lead cleaner are the norm, and a one-bedroom takes about 90 minutes. Access is a key at the desk or a lockbox, and our teams handle permit parking on the hill without it affecting your quote. Every visit is priced upfront with a 100% satisfaction guarantee.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes. We provide insurance certificates, book the freight elevator where required, and check in with the concierge so you need not be home.",
      },
      {
        question: "Can you leave harbor-facing windows streak-free?",
        answer:
          "Yes. Interior glass is included in deep cleans and available as an add-on to routine visits, finished with a squeegee for a clear result.",
      },
      {
        question: "Is there a fee for third-floor walk-ups on the hill?",
        answer:
          "No. Stairs and permit parking are part of working in Charlestown and never appear on a quote.",
      },
    ],
  ...
  "jamaica-plain": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "On request, exclusively and at no extra charge. Our plant-based, fragrance-free line becomes a permanent preference on your account.",
      },
      {
        question: "Can we book Saturday morning cleanings?",
        answer:
      ...
      },
      {
        ...
        answer:
          "Yes. One card is charged per visit, and many JP households rotate the card on file or settle up among themselves.",
      },
    ],
  ...
  newton: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Many Newton condo buildings require one. We provide it to management within a business day of your request.",
      },
      {
        question: "Do you clean rental units in two-family homes?",
        answer:
          "Yes. Tenants can book directly, or landlords can arrange recurring or turnover cleans and be invoiced separately.",
      },
      {
        question: "Can I keep the same cleaner I had for my house?",
        answer:
          "If you were a customer before downsizing, we do our best to keep your lead cleaner assigned to your new home.",
      },
    ],
  ...
  somerville: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. One card is charged per visit and you can rotate the card on file or settle up however works for the household.",
      },
      {
        question: "Do you clean condos at Assembly Row?",
        answer:
          "Regularly. We provide insurance certificates, follow elevator rules, and coordinate with the concierge so you need not be home.",
      },
      {
        question: "How early should I book around September 1?",
        answer:
          "Two to three weeks ahead for late-August and September 1 dates, which are the busiest cleaning days of the year in Somerville.",
      },
    ],
  ...
  "south-boston": {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes, in most major buildings. We deliver insurance certificates, reserve freight elevators where required, and check in with the concierge.",
      },
      {
      ...
      },
      {
        ...
        answer:
          "Yes. Brick is dusted and spot cleaned with a pH-neutral solution; polished concrete gets a neutral cleaner, never an acidic one.",
      },
    ],
  ...
  "south-end": {
    ...
    intro: [
      ...
      "South End renters include professionals walking to Back Bay and the hospitals and a large community with restaurant and creative-industry hours. That is why we schedule seven days a week and why Sunday afternoons are a common standing slot here. Plant-based, fragrance-free products are available at no extra cost. A one-bedroom takes about 90 minutes, pricing is quoted upfront, and every visit carries a 100% satisfaction guarantee.",
    ],
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          "Yes, regularly. Garden levels have their own dust and humidity patterns and our teams pay extra attention to sills, corners, and bathroom ventilation.",
      },
      {
        question: "Can I schedule a Sunday cleaning?",
        answer:
          "Yes. We operate seven days a week and Sunday afternoons are a popular standing slot for South End residents with weekend work schedules.",
      },
      {
        question: "Do you clean SoWa lofts and Ink Block condos?",
        answer:
          "Yes. We provide insurance certificates to management, follow elevator rules, and coordinate concierge access.",
      },
    ],
